...
module.exports = structr({
	...
	"dumpProfile": function(profileName, callback) {
		this.collection.remove({ profile: profileName }, { multi: true }, callback);
	},
	...
	"update": function(item, onInsert) {
		...
		step(
			...
			on.success(function(cachedItem) {
				...
				//otherwise update it
				return col.update({ _id: cachedItem._id }, { $set: item }, this);
			}),
